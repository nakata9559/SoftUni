package _23_PastExams._2023_04_April_18.vehicleShop.common;

public class ExceptionMessages {
    public static final String WORKER_NAME_NULL_OR_EMPTY = "Worker name cannot be null or empty.";

    public static final String WORKER_STRENGTH_LESS_THAN_ZERO = "Cannot createNew a Worker with negative strength.";

    public static final String VEHICLE_NAME_NULL_OR_EMPTY = "Vehicle name cannot be null or empty.";

    public static final String VEHICLE_STRENGTH_LESS_THAN_ZERO = "Cannot createNew a Vehicle requiring negative strength.";

    public static final String TOOL_POWER_LESS_THAN_ZERO = "Cannot createNew a Tool with negative power.";
