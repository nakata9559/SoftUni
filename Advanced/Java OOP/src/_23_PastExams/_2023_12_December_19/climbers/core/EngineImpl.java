...
import _23_PastExams._2023_12_December_19.climbers.common.Command;
...
public class EngineImpl implements Engine{
    ...
    private String addClimber(String[] data) {
        ...
        return this.controller.addClimber(climberType, climberName);
    }
    ...
    private String addMountain(String[] data) {
        ...
        return this.controller.addMountain(mountainName, peak);
    }
    private String removeClimber(String[] data) {
        String climberName = data[0];

        return this.controller.removeClimber(climberName);
    }

    private String startClimbing(String[] data) {
        String mountainName = data[0];

        return this.controller.startClimbing(mountainName);
    }
